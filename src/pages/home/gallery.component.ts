...
export class GalleryComponent {
  images = [
    { url: 'https://images.unsplash.com/photo-1620331311520-246422fd82f9?q=80&w=1000&auto=format&fit=crop', alt: 'Haircut in progress' },
    ...
    { url: 'https://images.unsplash.com/photo-1571781926291-28b46877b8b5?q=80&w=1000&auto=format&fit=crop', alt: 'Product Detail' },
  ];
}