...
export class TestimonialsComponent {
  ...
  reviews = [
    { text: "Une expérience hors du temps. Je n'ai jamais eu une couleur aussi vibrante et naturelle.", author: "Marie L.", service: "Balayage Lumière" },
    { text: "Le cadre est somptueux, l'équipe aux petits soins. C'est mon moment de luxe mensuel.", author: "Sophie D.", service: "Soin Tokyo" },
    { text: "Thomas a su exactement ce qu'il me fallait sans que je dise un mot. Un vrai artiste.", author: "Camille R.", service: "Coupe Signature" }
  ];
