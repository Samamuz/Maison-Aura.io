  ...
  template: `
    <div class="fixed bottom-6 right-6 z-[999] flex flex-col items-end font-sans">
        ...
        *ngIf="isOpen()"
        ...
        <div class="bg-deepBlack p-4 flex justify-between items-center text-ivory">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="font-serif italic text-lg">Concierge Aura</h3>
      ...
      <button 
        ...
        <span class="relative z-10 text-2xl font-serif italic" *ngIf="!isOpen()">A</span>
        <span class="relative z-10 text-xl" *ngIf="isOpen()">↓</span>
      </button>
